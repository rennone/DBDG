...
namespace DBDG
{
  ...
  GLModelManager::Mesh::Mesh(aiMesh *mesh)
  {
  ...
  void GLModelManager::Mesh::draw(const std::vector<Material> &materials) const
  {
  ...
  GLModelManager::Node::Node( aiNode* node)
  {
  ...
  void GLModelManager::Node::draw( const std::vector<Mesh> &meshes, const std::vector<Material> &materials) const
  {
    glPushMatrix();
  ...
  void GLModelManager::AssimpModel::render() const
  {
  ...
  void GLModelManager::AssimpModel::renderWithAlpha(const float &alpha)  const
  {
    render();
  }
  void GLModelManager::AssimpModel::renderWithColor3(const Color3 &color)const
  {
    render();
  }
  void GLModelManager::AssimpModel::renderWithColor4(const Color4 &color)const
  {
    render();
  }

  void GLModelManager::AssimpModel::dispose()
  {
  }

  GLModelManager::AssimpModel::~AssimpModel()
  {
  }
}
